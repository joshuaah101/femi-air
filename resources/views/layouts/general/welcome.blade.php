...
<header class="bg-plane3-bg bg-center bg-cover bg-no-repeat h-1/2 xs:px-4 md:px-8 py-3 xs:w-full">
    ...
    <div class="flex md:justify-between items-center xs:flex-col md:flex-row px-2 py-8 xs:space-y-8 md:space-y-0">
        ...
        <div class="xs:w-full md:w-1/3">
            <div class="flex justify-center text-2xl text-white font-bold font-mono">
                - Flight search -
            </div>
            <form action="ticket" method="POST" id="reservationForm" class="grid xs:grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-5 px-8 py-12  bg-transparent border-b-2 border-orange-500 shadow-2xl rounded">
                ...
                <div class="flex flex-col space-y-3 justify-end">
                    <label class=""></label>
                    <button type="submit" id="reservationBtn" class="bg-orange-500 px-2 py-3 text-orange-100 sm:w-full mt-5 rounded hover:text-orange-500 hover:bg-white font-semibold text-md flex justify-center transition duration-300">
