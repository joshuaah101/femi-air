    ...
    <main class="my-8 px-8">
        <form action="" method="POST" id="ticketForm">
            ...
            <section class="mt-5 bg-white p-4 rounded shadow-2xl">
                ...
                <div class="my-6">
                    <button type="submit" class="bg-blue-700 text-blue-100 px-2 py-3 rounded xs:w-full sm:w-1/2 md:w-1/3 
                    hover:bg-blue-600 font-semibold font-mono focus:outline-none
