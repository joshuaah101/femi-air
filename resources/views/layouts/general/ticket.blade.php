    ...
    <main class="my-8 px-8">
        <div class="bg-white px-5 py-4 shadow-lg rounded">
            <section class="flex justify-between items-center border-b-2 py-3">
                ...
                <div class="flex justify-between items-center space-x-5 font-bold">
                    ...
                    <span class="{{ request()->is('summary') ? 'border-b-2 border-red-500' : '' }} py-2">Summary and confirmation</span>
            ...
            <div class="flex space-x-12">
                    ...
                    <form action="" method="POST" id="ticketForm">
                        ...
                        <div class="">
                            <section class="bg-white py-8 px-4 rounded shadow-2xl">
                                ...
                                <h2 class="py-5 text-lg font-bold text-gray-500">Passenger  {{-- the number will be dynamic  --}} 1:</h2> {{-- this represents the number of tickets selected, i.e the number of entity traveling with the user and the user himself--}}
                                ...
                                <div class="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-3">
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="gender" class="text-sm text-gray-800 font-semibold">Gender <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="firstName" class="text-sm text-gray-800 font-semibold">First name <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="lastName" class="text-sm text-gray-800 font-semibold">Last name <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="dateOfBirth" class="text-sm text-gray-800 font-semibold">Date of birth <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                        <input type="date" name="dateOfBirth" id="dateOfBirth" class="shadow border border-gray-400 py-3 px-2 rounded focus:outline-none placeholder-gray-700 focus:bg-blue-100 focus:text-gray-900 text-sm" required/>
                                    </div>
                                ...
                                <div class="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-3">
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="email" class="text-sm text-gray-800 font-semibold">E-mail <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="phone" class="text-sm text-gray-800 font-semibold">Phone number <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                                    ...
                                    <div class="mt-6 flex flex-col space-y-2">
                                        <div class="flex space-x-1 items-center">
                                            ...
                                            <label for="state" class="text-sm text-gray-800 font-semibold">State <span class="text-red-600 text-lg">*</span></label>
                                        </div>
                ...
                <div class="w-1/4">
                    <div class="mt-5 rounded shadow-md">
                        ...
                        <div class="list-style-none space-y-4 font-medium text-sm text-gray-500 p-3 divide-y-2 divide-gray-400">
