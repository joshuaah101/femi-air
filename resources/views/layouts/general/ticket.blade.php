...
<section class="px-8 py-4 mt-3">
    <form action="" method="POST" id="reservationForm" class="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-x-4 gap-y-5 px-12 py-8 shadow-lg bg-blue-100">
        ...
        <div class="flex flex-col space-y-3" id="hide-rDate">
            ...
            <input type="date" name="returningDate" id="returningDate" class="shadow border border-gray-400 py-2 px-2 rounded focus:outline-none placeholder-gray-700 focus:bg-blue-100 focus:text-gray-900 text-sm" required />
        </div>
