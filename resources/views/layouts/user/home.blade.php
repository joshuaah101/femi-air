    ...
    <main class="flex justify-between">
        ...
        <div class="xs:hidden md:block w-1/6 bg-white h-screen shadow-lg top-0 left-0 fixed">
            ...
            <div class="py-5 px-2 text-blue-800 space-y-2 mt-5">
                <a href="?menu=dash" class="{{ request()->is('user/*') ? 'shadow-xl rounded bg-blue-700 text-blue-100 hover:bg-white  hover:shadow-md' : ''}}text-sm block px-5 py-3 font-semibold  hover:text-blue-900 hover:font-bold">
                    Dashboard
                </a>
                <a href="?menu=history" class="{{ request()->is('history/*') ? 'shadow-xl rounded bg-gray-100 hover:bg-white  hover:shadow-md' : ''}}text-sm block px-5 py-3 font-semibold hover:bg-gray-100 hover:text-blue-900 hover:font-bold">
                    Ticket history
                </a>
                <a href="?menu=profile" class="{{ request()->is('profile/*') ? 'shadow-xl rounded bg-gray-100 hover:bg-white  hover:shadow-md' : ''}}text-sm block px-5 py-3 font-semibold hover:bg-gray-100 hover:text-blue-900 hover:font-bold">
                    Profile
                </a>
        ...
        <div class="xs:ml-0 flex md:ml-1/6 py-8 px-5">
            {{-- header navigation --}}
            @section('header')
            <header class="bg-white top-0 fixed md:ml-3 right-0 xs:left-0 md:left-40 p-4 shadow-lg text-sm text-blue-800 border-l-2 border-blue-700 font-semibold z-10">
