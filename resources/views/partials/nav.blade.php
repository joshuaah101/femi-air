<nav class="bg-white shadow-2xl">
    <div class="px-4 md:px-8 mx-auto">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center">
                ...
                @else
                    <a href="{{ url('login') }}"
                       class="{{ request()->is('login') ? 'bg-orange-500 hover:bg-white border-t-2 border-gray-500' : 'hover:text-orange-500 ' }}
                           text-xs font-semibold px-2 py-4 text-gray-900 transition duration-300">
                        Login
                    </a>

                    <a href="{{ url('register') }}"
                       class="{{ request()->is('register') ? 'bg-orange-500 hover:bg-white border-t-2 border-gray-500' : 'hover:text-orange-500 ' }}
    ...
    <div class="hidden mobile-menu md:hidden py-3 px-4">
        <a href="/"
           class="{{ request()->is('/') ? 'text-purple-700 hover:text-blue-100 font-bold' : '' }} flex items-center text-md px-5 py-3 text-blue-700 hover:text-blue-600 font-bold">
            <span class="mr-1">
