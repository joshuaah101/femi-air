@section('footer')
    <footer class="mt-5 bg-gray-600">
        <section class="md:px-32 py-6 grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            <div class="p-3">
                <h1 class="text-2xl text-gray-300 font-mono">
                    Contact
                </h1>
                <div class="mt-5 text-sm">
                    <p class="mt-2 text-gray-100 leading-4">
                        E-mail : info@femi-air.com
                    </p>
                    <p class="mt-3">
                        <a href="tel:08023235658" class="text-gray-100 hover:text-gray-400">
            ...
            <div class="p-3">
                ...
                <div class="mt-5 flex flex-col space-y-2 text-sm ">
                    <a href="/" class="{{ request()->is('/') ? 'text-yellow-400 font-semibold' : '' }}
                        text-gray-100 hover:text-gray-400 flex items-center">
                        <span class="mr-2">
