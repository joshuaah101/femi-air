<nav class="shadow-xl font-semibold xs:left-0 md:left-1/6 xs:top-0 fixed w-full xs:bg-white md:bg-none border-b-2 border-blue-100">
    ...
    <div class="p-4 hidden md:hidden mobile-menu transition duration-1000 ease-in-out">
        ...
        <a href="?menu=bookTicket" class="{{ $menuUrl == 'bookTicket' ? 'hover:bg-blue-100 hover:text-blue-900 rounded rounded-r-full shadow-outline-blue' : '' }} flex items-center text-md px-5 py-3 text-blue-700 hover:text-blue-600 font-semibold">
            <span class="mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
